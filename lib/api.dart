...
class _ApiPageState extends State<ApiPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          backgroundColor: Color.fromARGB(255, 165, 126, 242),
        ),
        body: Column(
          children: [
            Expanded(
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                              ...
                              subtitle: Text('All episodes: ' +
                                  Cartoons.episodes.toString()),
  ...
  Future<void> _showMyDialog(String title, List creator, List genre,
      int episodes, String image, int runtime_in_minutes) async {
                  ...
                  image.isNotEmpty
                      ? Image.network(
                          ...
                          errorBuilder: (context, error, stackTrace) {
                            return Icon(Icons.error,
                                color: Color.fromARGB(255, 165, 126, 242));
                          },
                        )
